...
const MENTOR_KEY = "imba-match-mentor-token";
...
export const mentorToken = ref(read(MENTOR_KEY));
...
export function setMentorToken(value) {
  mentorToken.value = value || "";
  write(MENTOR_KEY, mentorToken.value);
}
